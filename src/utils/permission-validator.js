...
class PermissionValidator {
   ...
   */
  async getUserSpecificPermissions(_userId, _serverId) {
   ...
   */
  async checkIfServerOwner(_userId, _serverId) {
    // This would check if the user is the server owner via Discord API
    return false;
  }

  async checkDiscordAdminPermissions(_userId, _serverId) {
    // This would check if the user has admin permissions via Discord API
    return false;
  }

  async checkDiscordModeratorPermissions(_userId, _serverId) {
  ...
  getAvailablePermissions() {
    ...
    for (const [_roleName, roleData] of this.roles) {
